...
import LogoAnimation from './LogoAnimation';  // Import LogoAnimation
...
function Login() {
  ...
  const [showAnimation, setShowAnimation] = useState(false);  // To show the animation(Initially false)
  ...
  // This function handles the Register link click
  const handleRegisterClick = (e) => {
    e.preventDefault();
    setShowAnimation(true);  // Show the animation
  };

  // After completing go to registernpage
  ...
  return (
    <div className="slide-in">
      {showAnimation ? (  // If animation is triggered, show it
            ...
            <MDBCol md='3'>
              <div style={{
                ...
                <div className='text-center mt-4 pt-2'>
                  ...
                  {/* Register link with onClick to trigger animation */}
                  <p className="small fw-bold mt-2 pt-1 mb-2">Do not have an account? <a href="#" onClick={handleRegisterClick} className="link-danger">Register</a></p>
                </div>
              </div>
            </MDBCol>
          </MDBRow>
